...
const education = [
  {
    ...
    description: "Spécialité Intelligence Artificielle et Data Science",
  },
  {
    period: "2022 - 2024",
    title: "Classes Préparatoires",
    institution: "EMSI Rabat",
    description: "Formation scientifique intensive",
  },
];
  ...
  return (
    <section id="education" className="py-24 relative">
      <div className="container mx-auto">
        ...
        >
          Formation <span className="text-gradient-accent">Académique</span>
        </motion.h2>
